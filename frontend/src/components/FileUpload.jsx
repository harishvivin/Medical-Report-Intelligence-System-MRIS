    ...
    <div className="w-full">
      <div
        ...
        className={`relative overflow-hidden cursor-pointer rounded-2xl p-8 text-center transition-all duration-300 glass-panel border-2 ${
          dragActive
            ? 'border-emerald-500 bg-emerald-500/10 shadow-glow-emerald scale-[1.01]'
            : activeDoc
            ? 'border-emerald-500/40 bg-white/60 dark:bg-slate-900/60'
            : 'border-slate-300 dark:border-slate-800 hover:border-emerald-500/50 hover:bg-white/80 dark:hover:bg-slate-900/80'
        }`}
      >
        <input
          ref={fileInputRef}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center gap-3">
          {progress > 0 ? (
            ...
            <div className="flex items-center justify-between w-full max-w-xl glass-card border border-emerald-500/40 p-4 rounded-xl">
              ...
              <button
                ...
                className="px-3 py-1.5 rounded-lg bg-slate-200 dark:bg-slate-800 hover:bg-slate-300 dark:hover:bg-slate-700 text-xs font-medium text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 transition"
              >
            ...
            <>
              <div className="w-14 h-14 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-500 dark:text-emerald-400 mb-1 group-hover:scale-110 transition">
                <UploadCloud className="w-7 h-7" />
              </div>
              <div>
                <p className="text-base font-semibold text-slate-800 dark:text-slate-200">
                  Drag & drop your medical report PDF here, or <span className="text-emerald-600 dark:text-emerald-400 underline underline-offset-4">browse file</span>
                </p>
